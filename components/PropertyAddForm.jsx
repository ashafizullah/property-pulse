...
const PropertyAddForm = () => {
  ...
  const handleChange = (e) => {
    ...
    //Check if the name contains a dot, which indicates a nested key
    if (name.includes('.')){
      //Split the name into the outer key and inner key
      ...
      //If the name does not contain a dot, it is a top-level key
      setFields((prevFields) => ({
        ...prevFields,
        [name]: value
      }))
  ...
  const handleAmenitiesChange = (e) => {
    ...
    //update state with the new amenity list
    setFields((prevFields) => ({
      ...prevFields,
